...
def val(args, val_loader, model, epoch):
    ...
    for iter, batched_inputs in enumerate(val_loader):
        ...
        """
        map = np.zeros([gt.shape[0], gt.shape[1], 3])
        index_1 = np.where(pr == 1)
        index_0 = np.where(pr == 0)
        map[index_1] = [255, 255, 255]
        map[index_0] = [0, 0, 0]
...
def ValidateSegmentation(args):
    ...
    if args.file_root == 'LEVIR':
        args.file_root = '/home/ldy/project_py/A2Net-main/data/LEVIR_CD'
    elif args.file_root == 'BCDD':
        args.file_root = '/home/guan/Documents/Datasets/ChangeDetection/BCDD'
    elif args.file_root == 'SYSU':
        args.file_root = '/home/ldy/project_py/A2Net-main/data/SYSU-CD'
    elif args.file_root == 'DSIFN':
        args.file_root = '/home/ldy/project_py/A2Net-main/data/DSIFN_CD'
