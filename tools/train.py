...
def val(args, val_loader, model, epoch):
    ...
    for iter, batched_inputs in enumerate(val_loader):
        ...
        if args.onGPU == True:
            pre_img = pre_img.cuda(args.gpu_id)
            target = target.cuda(args.gpu_id)
            post_img = post_img.cuda(args.gpu_id)
...
def trainValidateSegmentation(args):
    ...
    model = BaseNet(model_size='1.0x', fe_nc=48)

    args.savedir = args.savedir + '_' + args.file_root + '_iter_' + str(args.max_steps) + \
                   '_lr_' + str(args.lr) + '_b_' + str(args.batch_size) + '/'
    args.vis_dir = args.savedir + '/Vis/'

    if args.file_root == 'LEVIR':
        args.file_root = '/home/ldy/project_py/data/LEVIR_CD'
    elif args.file_root == 'BCDD':
        args.file_root = '/home/guan/Documents/Datasets/ChangeDetection/BCDD'
    elif args.file_root == 'SYSU':
        args.file_root = '/home/ldy/project_py/data/SYSU-CD'
    elif args.file_root == 'DSIFN':
        args.file_root = '/home/ldy/project_py/data/DSIFN_CD'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--gpu_id', type=int, default=1, help='apply multi-scale training, default False')
